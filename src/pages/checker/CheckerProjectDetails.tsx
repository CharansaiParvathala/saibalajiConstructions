...
export default function CheckerProjectDetails() {
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Button
                onClick={() => navigate(`/checker/review-submissions?projectId=${project.id}`)}
              >
                Review Submissions
              </Button>
              <Button
                onClick={() => navigate(`/checker/review-history?projectId=${project.id}`)}
              >
                Review History
              </Button>
            </div>
