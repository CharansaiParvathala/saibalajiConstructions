        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Button
                onClick={() => navigate(`/admin/statistics?projectId=${project.id}`)}
              >
                View Statistics
              </Button>
              <Button
                onClick={() => navigate(`/admin/vehicles?projectId=${project.id}`)}
              >
                Manage Vehicles
              </Button>
              <Button
                onClick={() => navigate(`/admin/drivers?projectId=${project.id}`)}
              >
                Manage Drivers
              </Button>
              <Button
                onClick={() => navigate(`/admin/backup?projectId=${project.id}`)}
              >
                Backup Data
              </Button>
              <Button
                onClick={() => navigate(`/admin/export-data?projectId=${project.id}`)}
              >
                Export Data
              </Button>
            </div>
